...
return ((vm, host) => {
		...
		EXTENSIONS["." + ext] = (module, filename, dirname) => {
			if (vm.options.require.context !== 'sandbox') {
				...
				try {
					...
					var code = getGlobalCode(`(function (exports, require, module, __filename, __dirname) { 'use strict'; ${contents} \n});`);
	...
	const _requireBuiltin = function(modulename) {
		...
		if (modulename === 'events') {
			try {
				const script = new Script(getGlobalCode(`(function (exports, require, module, process) { 'use strict'; ${BUILTIN_MODULES[modulename]} \n});`), {
